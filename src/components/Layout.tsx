...
export default function Layout() {
  return (
    <div className="min-h-screen flex flex-col">
      <header className="no-print bg-neon px-6 py-4 flex items-center gap-6">
        <Link to="/" className="text-3xl font-black tracking-tight text-void hover:text-void/70 transition-colors leading-none">
          <span className="text-lava">MAX</span><span className="text-void">MATH</span><span className="text-lava">.</span>
        </Link>
